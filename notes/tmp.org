...
** 自我评价
*** chinese
  经过多年技术沉淀,从单线程开发到大并发多线开发再到分布式程序设计开发,积累了丰富的设计,编码,调试和解决问题的思路和经验,对于多线程大并发程序的设计和打桩并图形化调优性能,各种调试工具的应用都有比较扎实的技术功底,分布式数据一致性程序的设计编码和调试有比较深入的了解,在集群文件系统的整体设计和对象存储的实现方面也有比较丰富的经验
